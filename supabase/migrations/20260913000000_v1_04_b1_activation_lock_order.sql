...
declare a public.gsc_oauth_attempts; c public.connections; old_ref uuid; result public.organic_evidence_sources;
begin
  if auth.role() <> 'service_role' then raise exception 'SERVICE_ROLE_REQUIRED'; end if;

  -- Begin and activation both acquire the Connection lock before attempt work.
