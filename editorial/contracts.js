...
export const COMPONENT_DATA_SCHEMAS = Object.freeze({
  ...
  product_recommendation: component("product_recommendation", { heading: string, product_id: { $ref: "#/$defs/product_id" }, recommendation_context: string, relevance_reason: string, cta_direction: string, cta_label: string }, ["heading", "product_id", "recommendation_context", "relevance_reason", "cta_direction"]),
