...
### Current CMS value / rollback source
...
- Do not write unless the current CMS value hash still equals `cab90254eb8700633239c7e848924783eb643a1136b42d75c8ee9653415ccbdb`.
- Preserve the rollback source exactly.
...
- Do not write unless the live page hash still equals `a5db743344a3c3bd732fa0acddb20df1bbe9a4097d9ba1f9070264e1f93b8c5f`.
- Do not write unless the current CMS value hash still equals `92d491526ff3102eeec7c734264ac925bf909ed86b6406f00b5fdc5b458b0401`.
- Preserve the rollback source exactly.
...
- Do not write unless the live page hash still equals `a5db743344a3c3bd732fa0acddb20df1bbe9a4097d9ba1f9070264e1f93b8c5f`.
- Do not write unless the current CMS value hash still equals `92794eebd4cea5df6fbb577943794509a413d4fb2ad1ac2885c223ed8e1afcc5`.
- Preserve the rollback source exactly.
...
- Do not write unless the live page hash still equals `a5db743344a3c3bd732fa0acddb20df1bbe9a4097d9ba1f9070264e1f93b8c5f`.
- Do not write unless the current CMS value hash still equals `2b7a205a2f4e4eb4f29d0f4ac84b4e0e00b71d5d7def5e9327dd8c3d3c477f70`.
- Preserve the rollback source exactly.
...
2. Read each target CMS field immediately before writing and require its hash to equal the recorded field hash.
3. On either mismatch, stop and reverify.
4. Preserve each exact current CMS value as the rollback source.
5. A future write remains subject to separate human implementation approval and post-write verification.
