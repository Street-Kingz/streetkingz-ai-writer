...
- Under O-016, portable logical recovery deliberately invalidates connector credentials and requires customer re-authorisation; it does not restore Vault ciphertext identity.
