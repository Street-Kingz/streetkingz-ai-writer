...
- Under accepted decision O-011, portable logical recovery invalidates connector credentials and requires customer re-authorisation. Credential-preserving recovery remains dependent on a supported provider-managed restore plan.
